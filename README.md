...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/amset-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11393&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/amset-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `amset` can be installed with:

```
conda install amset
```

It is possible to list all of the versions of `amset` available on your platform with:
